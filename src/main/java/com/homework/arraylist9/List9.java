...
public class List9 {
  ...
  public static void copy(ArrayList<String> destination, ArrayList<String> source) {   //Collections.copy(destination, source)
  ...
  public static void addAll(ArrayList<String> list, String... strings) { //Collections.addAll(list, strings)
    for (String string : strings) {
      list.add(string);
    }
  }

  public static void replaceAll(ArrayList<String> list, String oldValue, String newValue) {  //Collections.replaceAll(list, oldValue, newValue)
